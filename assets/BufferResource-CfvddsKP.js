import{w as U,r as g,s as c,u as S,B as _,t as m,E as I,x as h}from"./TableRoom-B9cEckDl.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]="7f31cb43-fcc2-4269-9a11-52bd76602bdf",e._sentryDebugIdIdentifier="sentry-dbid-7f31cb43-fcc2-4269-9a11-52bd76602bdf")}catch{}})();const b={name:"local-uniform-bit",vertex:{header:`
        ...
        `}},T={...b,vertex:{...b.vertex,header:b.vertex.header.replace("group(1)","group(2)")}},w={name:"local-uniform-bit",vertex:{header:`
    ...
    `];let n=0;for(let l=0;l<e.length;l++){const f=e[l],x=f.data.name;let y=!1,i=0;for(let u=0;u<p.length;u++)if(p[u].test(f.data)){i=f.offset/4,r.push(`name = "${x}";`,`offset += ${i-n};`,p[u][t]||p[u].ubo),y=!0;break}if(!y)if(f.data.size>1)i=f.offset/4,r.push(a(f,i-n));else{const u=s[f.data.type];i=f.offset/4,r.push(`
                    v = uv.${x};
                    offset += ${i-n};
                    ${u};
                `)}n=i}const o=r.join(`
